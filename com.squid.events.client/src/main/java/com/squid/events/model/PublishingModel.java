 ...
 *
 */
public class PublishingModel extends UsageModel {
    ...
    public PublishingModel(String schemaName, String eventType) {
     ...
     * @return this
     */
    public PublishingModel withAccountID(String accountID) {
     ...
     * @return this
     */
    public PublishingModel withAuthenticationMethod(String methodID) {
